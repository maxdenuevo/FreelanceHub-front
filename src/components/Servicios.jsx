...
function Servicios() {
  return (
    <div className="servicios-home">
        ...
        <img className="img-servicios" src="src/assets/images/tareas.png" alt=""/>
        <div>
        ...
        <img className="img-servicios2 p-4" src="src/assets/images/Progreso.png" alt=""/>
        <div>
        ...
        <img className="img-servicios p-4" src="src/assets/images/Contrato.png" alt=""/>
        <div>
        ...
        <div className="herramientas-home2">
        <img className="img-servicios p-4" src="src/assets/images/Pago.png" alt=""/>
        <div>
        ...
        <div className="herramientas-home">
        <img className="img-servicios2 p-4" src="src/assets/images/Recordatorio.png" alt=""/>
        <div>
