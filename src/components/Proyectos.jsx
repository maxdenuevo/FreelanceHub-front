    ...
    <div id='proyectos-page'>
      ...
      <div className="d-flex m-5">
        <div id='sec-proyect' className="">
          ...
          <button id='btn-proyecto-nuevo' className='btn m-3' onClick={irAProyectoNuevo}><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
