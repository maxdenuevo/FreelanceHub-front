        ...
        <div className="Dashboard d-flex">
            <div className="sidebar p-3" style={{ width: "200px", height: "150vh" }}>
                ...
                <div className="nav d-flex align-items-start flex-column nav-pills mt-5 me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button className="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-house pe-2 pb-1" viewBox="0 0 16 16">
                    ...
                    <button className="nav-link" id="v-pills-proyectos-tab" data-bs-toggle="pill" data-bs-target="#v-pills-proyectos" type="button" role="tab" aria-controls="v-pills-proyectos" aria-selected="false"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-kanban pe-2 pb-1" viewBox="0 0 16 16">
                    ...
                    <button type="button" class="btn" id="btn-modal" data-bs-toggle="modal" data-bs-target="#exampleModal"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-box-arrow-right pe-2 pb-1" viewBox="0 0 16 16">
