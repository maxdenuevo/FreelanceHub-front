...
return (
    <div className="Dashboard d-flex">
      <div className="sidebar p-3">
        <h1 className="">Tu Panel de Proyectos</h1>
        {usuarioEmail && <p>{usuarioEmail}</p>}
        <div className="nav d-flex align-items-start flex-column nav-pills mt-4 me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          ...
          <path d="M9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.5zm0 1v2A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z"/></svg>Contratos</Link>
          ...
          <path fillRule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708z"/></svg>Cerrar Sesión</button>
          <div className="modal fade" id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-body">
              <p className='d-flex justify-content-center'><strong>¿Seguro que desea cerrar sesión?</strong></p>
            </div>
